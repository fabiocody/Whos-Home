...
### people.json
To make *Who's Home* work, you have to provide a JSON file (located in the same directory as whoshome.py) containing the target addresses (only the last 3 bytes) and the corresponding names. Here's an example of how it should look.
```json
[
